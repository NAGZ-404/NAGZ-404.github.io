<html>
  <head>
    <meta charset="utf-8" />
    <title id = "homepage">Homepage</title>
      ...
      <header>
         <nav>
           <!-- <div class="dropdown">
             ...
             <a href="homepage.html"><img src="logos/logo.png"></a> -->
    ...
    <div id = "aboutme">
      <article>
        ...
        <div>
          ...
          <hr>
          <p>
            Currently studying Computer Science at Queen Mary University of London, I have a deep interest in various aspects of computer science, learning to overcome challenges and further my understanding.
            <br />
            <br />
            Having experience with languages such as Python and Java, I am quite skilled at it, as well as having done multiple projects such as a quiz and simulation games. Furthermore, I have a passion for areas such as video game development due to growing up with it, creating a deep interest for expanding my own knowledge on it.
            Outside of that I am into various forms of media, mostly invested in games, but also am trying to get into drawing, learning to drive and engage in sports like badminton.
          </p>
        </div>
